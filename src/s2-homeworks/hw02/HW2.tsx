...
// constants
const defaultAffairs: Array<AffairType> = [ // need to fix any              ВЫПОЛНЕНО
...
function HW2() {
    const [affairs, setAffairs] = useState<AffairType[]>(defaultAffairs) // need to fix any    ВЫПОЛНЕНО
