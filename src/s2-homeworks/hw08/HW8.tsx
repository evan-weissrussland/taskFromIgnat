...
/*
* 1 - дописать типы и логику (сортировка по имени, фильтрация по совершеннолетию) homeWorkReducer, проверить тестом  ВЫПОЛНЕНО
* 2 - дописать компоненту User  ВЫПОЛНЕНО
* 3 - сделать стили в соответствии с дизайном   +-выполнено
* */
